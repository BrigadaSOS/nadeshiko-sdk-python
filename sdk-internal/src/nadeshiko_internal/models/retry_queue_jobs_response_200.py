...
T = TypeVar("T", bound="RetryQueueJobsResponse200")



@_attrs_define
class RetryQueueJobsResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retry_queue_jobs_response_200 = cls(
            success=success,
        ...
        retry_queue_jobs_response_200.additional_properties = d
        return retry_queue_jobs_response_200
