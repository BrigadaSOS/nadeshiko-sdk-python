...
class Statistic:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if anime_id is not UNSET:
            field_dict["animeId"] = anime_id
        if category is not UNSET:
            field_dict["category"] = category
        if name_anime_romaji is not UNSET:
            field_dict["nameAnimeRomaji"] = name_anime_romaji
        ...
        if amount_sentences_found is not UNSET:
            field_dict["amountSentencesFound"] = amount_sentences_found
        if season_with_episode_hits is not UNSET:
            field_dict["seasonWithEpisodeHits"] = season_with_episode_hits
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        name_anime_romaji = d.pop("nameAnimeRomaji", UNSET)

        name_anime_en = d.pop("nameAnimeEn", UNSET)

        name_anime_jp = d.pop("nameAnimeJp", UNSET)

        amount_sentences_found = d.pop("amountSentencesFound", UNSET)

        _season_with_episode_hits = d.pop("seasonWithEpisodeHits", UNSET)
        ...
        if isinstance(_season_with_episode_hits,  Unset):
            ...
            season_with_episode_hits = StatisticSeasonWithEpisodeHits.from_dict(_season_with_episode_hits)
