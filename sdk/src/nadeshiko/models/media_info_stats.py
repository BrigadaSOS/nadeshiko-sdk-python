...
class MediaInfoStats:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        total_animes = d.pop("totalAnimes", UNSET)

        total_segments = d.pop("totalSegments", UNSET)

        full_total_animes = d.pop("fullTotalAnimes", UNSET)

        full_total_segments = d.pop("fullTotalSegments", UNSET)
