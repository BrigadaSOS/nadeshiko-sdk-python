...
OPERATIONS: tuple[OperationMetadata, ...] = (
    ...
    OperationMetadata(name="get_email_preferences_by_token", module_path=".api.email.get_email_preferences_by_token", paginated=False, doc="Read email preferences from an unsubscribe token"),
    ...
    OperationMetadata(name="update_email_preferences_by_token", module_path=".api.email.update_email_preferences_by_token", paginated=False, doc="Change email preferences from an unsubscribe token"),
