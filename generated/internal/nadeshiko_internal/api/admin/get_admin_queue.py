...
from ...models.get_admin_queue_queue_name import GetAdminQueueQueueName
from ...models.get_admin_queue_response_200 import GetAdminQueueResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetAdminQueueResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Error400 | Error401 | Error403 | Error404 | Error429 | Error500 | GetAdminQueueResponse200
]:
    return Response(
...
def sync_detailed(
    ...
    **Permissions:** `ADD_MEDIA`
    ...
    Returns:
        Response[Error400 | Error401 | Error403 | Error404 | Error429 | Error500 | GetAdminQueueResponse200]
    """
