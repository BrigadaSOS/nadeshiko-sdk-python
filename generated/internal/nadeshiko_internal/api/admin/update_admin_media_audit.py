...
from ...models.update_admin_media_audit_body import UpdateAdminMediaAuditBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/admin/media/audits/{name}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MediaAudit.from_dict(response.json())
...
def sync(
    ...
    **Permissions:** `ADD_MEDIA`
    ...
    Returns:
        Error400 | Error401 | Error403 | Error404 | Error429 | Error500 | MediaAudit
    """
