...
from ...models.bulk_update_reports_request import BulkUpdateReportsRequest
...
def sync_detailed(
    *,
    ...
    Unlike the batch endpoint which takes explicit IDs, this updates all matching reports in one
    operation.
