...
from ...models.get_admin_health_response_200 import GetAdminHealthResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetAdminHealthResponse200.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Error401 | Error403 | Error429 | Error500 | GetAdminHealthResponse200
    """
