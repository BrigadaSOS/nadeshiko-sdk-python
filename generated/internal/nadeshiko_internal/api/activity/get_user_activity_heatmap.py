...
) -> Error401 | Error403 | Error429 | Error500 | GetUserActivityHeatmapResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error401 | Error403 | Error429 | Error500 | GetUserActivityHeatmapResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error401 | Error403 | Error429 | Error500 | GetUserActivityHeatmapResponse200
    """
