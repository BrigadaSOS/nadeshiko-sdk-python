...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/lists/{id}/items/{media_id}".format(id=quote(str(id), safe=""),media_id=quote(str(media_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | ListUpdateItemResponse200 | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Error | ListUpdateItemResponse200]:
    return Response(
