...
T = TypeVar("T", bound="SearchMultipleResponseIncludesMedia")
...
class SearchMultipleResponseIncludesMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _src = dict(src_dict)
        search_multiple_response_includes_media = cls()
        ...
        search_multiple_response_includes_media.additional_properties = additional_properties
        return search_multiple_response_includes_media
