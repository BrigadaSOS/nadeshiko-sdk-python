...
T = TypeVar("T", bound="CollectionWithSegmentsIncludesMedia")


@_attrs_define
class CollectionWithSegmentsIncludesMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collection_with_segments_includes_media.additional_properties = additional_properties
        return collection_with_segments_includes_media
