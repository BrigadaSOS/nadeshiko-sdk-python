...
T = TypeVar("T", bound="SearchResponseIncludesMedia")


@_attrs_define
class SearchResponseIncludesMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _src = dict(src_dict)
        search_response_includes_media = cls()
        ...
        search_response_includes_media.additional_properties = additional_properties
        return search_response_includes_media
