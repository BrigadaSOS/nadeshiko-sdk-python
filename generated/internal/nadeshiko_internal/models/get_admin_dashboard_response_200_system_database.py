...
from ..models.get_admin_dashboard_response_200_system_database_status import (
    GetAdminDashboardResponse200SystemDatabaseStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAdminDashboardResponse200SystemDatabase")


@_attrs_define
class GetAdminDashboardResponse200SystemDatabase:
    """
    Attributes:
        status (GetAdminDashboardResponse200SystemDatabaseStatus):
