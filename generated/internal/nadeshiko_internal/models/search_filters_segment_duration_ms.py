...
T = TypeVar("T", bound="SearchFiltersSegmentDurationMs")


@_attrs_define
class SearchFiltersSegmentDurationMs:
    """Segment audio duration range filter (in milliseconds)

    Attributes:
        min_ (int | Unset): Minimum duration in ms Example: 1000.
        max_ (int | Unset): Maximum duration in ms Example: 10000.
    """
