...
T = TypeVar("T", bound="GetAdminDashboardOverviewResponse200Users")


@_attrs_define
class GetAdminDashboardOverviewResponse200Users:
    """
    Attributes:
        total_users (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_admin_dashboard_overview_response_200_users = cls(
            total_users=total_users,
            recently_registered_count=recently_registered_count,
            recently_active_count=recently_active_count,
        )

        get_admin_dashboard_overview_response_200_users.additional_properties = _src
        return get_admin_dashboard_overview_response_200_users
