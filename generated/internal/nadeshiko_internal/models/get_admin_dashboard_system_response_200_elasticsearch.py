...
class GetAdminDashboardSystemResponse200Elasticsearch:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = GetAdminDashboardSystemResponse200ElasticsearchStatus(d.pop("status"))
        ...
        index_size_bytes = _parse_index_size_bytes(d.pop("indexSizeBytes", UNSET))
        ...
        get_admin_dashboard_system_response_200_elasticsearch.additional_properties = d
