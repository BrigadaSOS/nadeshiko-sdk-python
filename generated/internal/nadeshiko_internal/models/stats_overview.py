...
T = TypeVar("T", bound="StatsOverview")
...
class StatsOverview:
    ...
    Attributes:
        ...
        translations (StatsOverviewTranslations):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        translations = StatsOverviewTranslations.from_dict(_src.pop("translations"))
        ...
        stats_overview.additional_properties = _src
