...
T = TypeVar("T", bound="SegmentContextResponseIncludesMedia")
...
class SegmentContextResponseIncludesMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _src = dict(src_dict)
        segment_context_response_includes_media = cls()
        ...
        segment_context_response_includes_media.additional_properties = additional_properties
        return segment_context_response_includes_media
