...
T = TypeVar("T", bound="AdminReviewRunShowResponse200")


@_attrs_define
class AdminReviewRunShowResponse200:
    """
    Attributes:
        run (ReviewCheckRun):
        reports (list[Report]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_review_run_show_response_200 = cls(
            run=run,
            reports=reports,
        )

        admin_review_run_show_response_200.additional_properties = d
        return admin_review_run_show_response_200
