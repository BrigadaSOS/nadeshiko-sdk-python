...
T = TypeVar("T", bound="AdminQueueStatsIndexResponse200Item")


@_attrs_define
class AdminQueueStatsIndexResponse200Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_queue_stats_index_response_200_item = cls(
            queue=queue,
            stuck_count=stuck_count,
            failed_count=failed_count,
        )

        admin_queue_stats_index_response_200_item.additional_properties = d
        return admin_queue_stats_index_response_200_item
