...
T = TypeVar("T", bound="AdminQueueFailedIndexResponse200Item")


@_attrs_define
class AdminQueueFailedIndexResponse200Item:
    """
    Attributes:
        id (str | Unset): Job ID
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_queue_failed_index_response_200_item = cls(
            id=id,
        ...
        admin_queue_failed_index_response_200_item.additional_properties = d
        return admin_queue_failed_index_response_200_item
