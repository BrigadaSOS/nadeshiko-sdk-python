...
T = TypeVar("T", bound="AdminReviewAllowlistCreateBody")


@_attrs_define
class AdminReviewAllowlistCreateBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_review_allowlist_create_body = cls(
        ...
        admin_review_allowlist_create_body.additional_properties = d
        return admin_review_allowlist_create_body
