...
from ..models.admin_dashboard_show_response_200_system_elasticsearch_status import (
    AdminDashboardShowResponse200SystemElasticsearchStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AdminDashboardShowResponse200SystemElasticsearch")


@_attrs_define
class AdminDashboardShowResponse200SystemElasticsearch:
    """
    Attributes:
        status (AdminDashboardShowResponse200SystemElasticsearchStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = AdminDashboardShowResponse200SystemElasticsearchStatus(d.pop("status"))
        ...
        admin_dashboard_show_response_200_system_elasticsearch = cls(
            status=status,
            version=version,
        ...
        admin_dashboard_show_response_200_system_elasticsearch.additional_properties = d
        return admin_dashboard_show_response_200_system_elasticsearch
