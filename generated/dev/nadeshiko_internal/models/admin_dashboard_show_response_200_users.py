...
T = TypeVar("T", bound="AdminDashboardShowResponse200Users")


@_attrs_define
class AdminDashboardShowResponse200Users:
    """
    Attributes:
        total_users (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_dashboard_show_response_200_users = cls(
            total_users=total_users,
            recently_registered_count=recently_registered_count,
            recently_active_count=recently_active_count,
        )

        admin_dashboard_show_response_200_users.additional_properties = d
        return admin_dashboard_show_response_200_users
