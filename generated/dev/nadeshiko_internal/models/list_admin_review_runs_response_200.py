...
T = TypeVar("T", bound="ListAdminReviewRunsResponse200")


@_attrs_define
class ListAdminReviewRunsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_admin_review_runs_response_200 = cls(
            runs=runs,
            pagination=pagination,
        )

        list_admin_review_runs_response_200.additional_properties = d
        return list_admin_review_runs_response_200
