...
if TYPE_CHECKING:
    from ..models.user_activity_stats_show_response_200_top_media_item import (
        UserActivityStatsShowResponse200TopMediaItem,
    )


T = TypeVar("T", bound="UserActivityStatsShowResponse200")


@_attrs_define
class UserActivityStatsShowResponse200:
    """
    Attributes:
        total_searches (int):
        total_exports (int):
        ...
        top_media (list[UserActivityStatsShowResponse200TopMediaItem]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for top_media_item_data in _top_media:
            top_media_item = UserActivityStatsShowResponse200TopMediaItem.from_dict(
                top_media_item_data
            )

            top_media.append(top_media_item)

        user_activity_stats_show_response_200 = cls(
        ...
        user_activity_stats_show_response_200.additional_properties = d
        return user_activity_stats_show_response_200
