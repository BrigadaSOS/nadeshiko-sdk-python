...
from ..models.admin_health_show_response_200_elasticsearch_status import (
    AdminHealthShowResponse200ElasticsearchStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AdminHealthShowResponse200Elasticsearch")


@_attrs_define
class AdminHealthShowResponse200Elasticsearch:
    """
    Attributes:
        status (AdminHealthShowResponse200ElasticsearchStatus):
        version (None | str | Unset):
        cluster_name (None | str | Unset):
        cluster_status (None | str | Unset): ES cluster health (green, yellow, red)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = AdminHealthShowResponse200ElasticsearchStatus(d.pop("status"))
        ...
        admin_health_show_response_200_elasticsearch = cls(
            status=status,
            version=version,
        ...
        admin_health_show_response_200_elasticsearch.additional_properties = d
        return admin_health_show_response_200_elasticsearch
