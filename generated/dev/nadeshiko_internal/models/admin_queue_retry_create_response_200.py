...
T = TypeVar("T", bound="AdminQueueRetryCreateResponse200")


@_attrs_define
class AdminQueueRetryCreateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_queue_retry_create_response_200 = cls(
            success=success,
            retried_count=retried_count,
            message=message,
        )

        admin_queue_retry_create_response_200.additional_properties = d
        return admin_queue_retry_create_response_200
