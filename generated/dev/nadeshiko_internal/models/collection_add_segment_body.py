...
T = TypeVar("T", bound="CollectionAddSegmentBody")


@_attrs_define
class CollectionAddSegmentBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collection_add_segment_body = cls(
            segment_uuid=segment_uuid,
            note=note,
        )

        collection_add_segment_body.additional_properties = d
        return collection_add_segment_body
