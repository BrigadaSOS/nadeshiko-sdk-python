...
T = TypeVar("T", bound="TranslationContent")
...
class TranslationContent:
    ...
    Attributes:
        ...
        content (None | str | Unset): Translated content Example: I am me, and you are you..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        translation_content = cls(
            is_machine_translated=is_machine_translated,
            content=content,
        )

        translation_content.additional_properties = d
