...
T = TypeVar("T", bound="SearchStatsResponseIncludesMedia")
...
class SearchStatsResponseIncludesMedia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        search_stats_response_includes_media = cls()
        ...
        search_stats_response_includes_media.additional_properties = additional_properties
        return search_stats_response_includes_media
