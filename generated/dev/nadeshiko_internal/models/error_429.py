...
class Error429:
    ...
    Attributes:
        code (Error429Code): Specific error code for programmatic handling
        ...
        status (Error429Status): The HTTP status code
        ...
        errors (Error429Errors | Unset): Optional map of field names to their error messages (for validation errors)
    """

    code: Error429Code
    title: str
    detail: str
    status: Error429Status
    type_: str | Unset = UNSET
    instance: str | Unset = UNSET
    errors: Error429Errors | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = Error429Code(d.pop("code"))

        title = d.pop("title")

        detail = d.pop("detail")

        status = Error429Status(d.pop("status"))
        ...
        errors: Error429Errors | Unset
        if isinstance(_errors, Unset):
            errors = UNSET
        else:
            errors = Error429Errors.from_dict(_errors)
