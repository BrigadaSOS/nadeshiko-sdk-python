...
T = TypeVar("T", bound="AdminDashboardShowResponse200Media")


@_attrs_define
class AdminDashboardShowResponse200Media:
    """
    Attributes:
        total_media (int):
        total_episodes (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_dashboard_show_response_200_media = cls(
        ...
        admin_dashboard_show_response_200_media.additional_properties = d
        return admin_dashboard_show_response_200_media
