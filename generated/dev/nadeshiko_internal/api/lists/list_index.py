...
) -> Error400 | Error401 | Error403 | Error429 | Error500 | list[List] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error400 | Error401 | Error403 | Error429 | Error500 | list[List]]:
    return Response(
...
def sync(
    ...
    **Permissions:** `READ_LISTS`
    ...
    Returns:
        Error400 | Error401 | Error403 | Error429 | Error500 | list[List]
    """
