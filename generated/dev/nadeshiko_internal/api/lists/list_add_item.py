...
def sync_detailed(
    ...
    **Permissions:** `UPDATE_LISTS`
    ...
    Returns:
        Response[Error400 | Error401 | Error403 | Error404 | Error409 | Error429 | Error500 | ListAddItemResponse201]
    """
...
def sync(
    ...
    **Permissions:** `UPDATE_LISTS`
    ...
    Returns:
        Error400 | Error401 | Error403 | Error404 | Error409 | Error429 | Error500 | ListAddItemResponse201
    """
