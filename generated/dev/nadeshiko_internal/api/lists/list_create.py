...
) -> Error400 | Error401 | Error403 | Error429 | Error500 | List | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error400 | Error401 | Error403 | Error429 | Error500 | List]:
    return Response(
...
def sync(
    ...
    **Permissions:** `CREATE_LISTS`
    ...
    Returns:
        Error400 | Error401 | Error403 | Error429 | Error500 | List
    """
