...
) -> Error401 | Error403 | Error429 | Error500 | SearchHealthCheckResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error401 | Error403 | Error429 | Error500 | SearchHealthCheckResponse]:
    return Response(
...
def sync(
    ...
    **Permissions:** `READ_MEDIA`
    ...
    Returns:
        Error401 | Error403 | Error429 | Error500 | SearchHealthCheckResponse
    """
