...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Error400 | Error401 | Error403 | Error404 | Error429 | Error500 | SearchStatsResponse
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error400 | Error401 | Error403 | Error404 | Error429 | Error500 | SearchStatsResponse]
    """
