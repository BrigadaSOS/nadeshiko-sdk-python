...
from ...models.collection_index_visibility import CollectionIndexVisibility
...
def _get_kwargs(
    *,
    visibility: CollectionIndexVisibility | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        visibility (CollectionIndexVisibility | Unset):  Example: private.
        cursor (int | Unset):
