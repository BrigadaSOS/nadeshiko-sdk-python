...
from ...models.user_activity_destroy_response_200 import UserActivityDestroyResponse200
...
) -> Error401 | Error500 | UserActivityDestroyResponse200 | None:
    if response.status_code == 200:
        response_200 = UserActivityDestroyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error401 | Error500 | UserActivityDestroyResponse200]:
    return Response(
...
def sync(
    ...
    **Permissions:** Session authentication (cookie-based).
    ...
    Returns:
        Error401 | Error500 | UserActivityDestroyResponse200
    """
