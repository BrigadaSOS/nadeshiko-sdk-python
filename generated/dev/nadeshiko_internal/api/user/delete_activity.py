...
from ...models.delete_activity_response_200 import DeleteActivityResponse200
...
) -> DeleteActivityResponse200 | Error401 | Error500 | None:
    if response.status_code == 200:
        response_200 = DeleteActivityResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteActivityResponse200 | Error401 | Error500]:
    return Response(
...
def sync(
    ...
    **Permissions:** Session authentication (cookie-based).
    ...
    Returns:
        DeleteActivityResponse200 | Error401 | Error500
    """
