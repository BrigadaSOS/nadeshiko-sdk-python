...
from ...models.user_activity_heatmap_show_response_200 import UserActivityHeatmapShowResponse200
...
) -> Error401 | Error500 | UserActivityHeatmapShowResponse200 | None:
    if response.status_code == 200:
        response_200 = UserActivityHeatmapShowResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error401 | Error500 | UserActivityHeatmapShowResponse200]:
    return Response(
...
def sync(
    ...
    **Permissions:** Session authentication (cookie-based).
    ...
    Returns:
        Error401 | Error500 | UserActivityHeatmapShowResponse200
    """
