...
T = TypeVar("T", bound="CoveredWordsUpdateResponse")


@_attrs_define
class CoveredWordsUpdateResponse:
    """Result of a word coverage update run

    Attributes:
        words_checked (int):  Example: 50000.
        newly_covered (int):  Example: 120.
        total_covered (int):  Example: 42000.
        percentage (float):  Example: 84.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        covered_words_update_response = cls(
        ...
        covered_words_update_response.additional_properties = _src
        return covered_words_update_response
