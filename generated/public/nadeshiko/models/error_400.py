...
from ..models.error_400_code import Error400Code, check_error_400_code
from ..models.error_400_status import Error400Status, check_error_400_status
...
class Error400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _src = dict(src_dict)
        code = check_error_400_code(_src.pop("code"))

        title = _src.pop("title")

        detail = _src.pop("detail")

        status = check_error_400_status(_src.pop("status"))
