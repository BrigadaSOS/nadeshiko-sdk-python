...
T = TypeVar("T", bound="CoveredWordsUpdateRequest")


@_attrs_define
class CoveredWordsUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        covered_words_update_request = cls(
            max_rank=max_rank,
            only_uncovered=only_uncovered,
        )

        covered_words_update_request.additional_properties = _src
        return covered_words_update_request
