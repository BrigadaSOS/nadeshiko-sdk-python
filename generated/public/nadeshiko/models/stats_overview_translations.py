...
T = TypeVar("T", bound="StatsOverviewTranslations")


@_attrs_define
class StatsOverviewTranslations:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stats_overview_translations = cls(
            total=total,
            en_human=en_human,
        ...
        stats_overview_translations.additional_properties = _src
        return stats_overview_translations
