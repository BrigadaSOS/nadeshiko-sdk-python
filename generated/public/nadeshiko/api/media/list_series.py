...
from ...models.series_list_response import SeriesListResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SeriesListResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Error400 | Error401 | Error403 | Error429 | Error500 | SeriesListResponse
    """
