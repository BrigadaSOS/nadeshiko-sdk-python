...
from ...models.list_familiar_media_response_200 import ListFamiliarMediaResponse200
...
) -> Error401 | Error403 | Error429 | Error500 | ListFamiliarMediaResponse200 | None:
    if response.status_code == 200:
        response_200 = ListFamiliarMediaResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error401 | Error403 | Error429 | Error500 | ListFamiliarMediaResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Error401 | Error403 | Error429 | Error500 | ListFamiliarMediaResponse200
    """
